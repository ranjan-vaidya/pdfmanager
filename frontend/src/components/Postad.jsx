  ...
  return (
    <div className='mt-8'>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col justify-center items-center my-12'>
                ...
                <input type='text' name='Brand' value={brand} onChange={(e)=>setBrand(e.target.value)} placeholder="Document Brand" className='bg-gray-100 w-64 p-2 flex items-center mb-3 outline-none text-sm flex-1' />
                <input type='text' name='Condition' value={condition} onChange={(e)=>setCondition(e.target.value)} placeholder="Document Condition" className='bg-gray-100 w-64 p-2 flex items-center mb-3 outline-none text-sm flex-1' />
